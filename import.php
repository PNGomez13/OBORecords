                                                ...
                                                if($arrFileName[1] == 'csv'){
                                                     $handle = fopen($_FILES['csv_data']['tmp_name'], "r");
                                                        while (($data = fgetcsv($handle, 10000, ",")) !== FALSE) {
                                                            ...
                                                            $item12 = mysqli_real_escape_string($db,$data[11]);
                                                            $item13 = mysqli_real_escape_string($db,$data[12]);
                                                            $item14 = mysqli_real_escape_string($db,$data[13]);
                                                            $item15 = mysqli_real_escape_string($db,$data[14]);
                                                            $item16 = mysqli_real_escape_string($db,$data[15]);
                                                            $item17 = mysqli_real_escape_string($db,$data[16]);
                                                            $item18 = mysqli_real_escape_string($db,$data[17]);
                                                            $item19 = mysqli_real_escape_string($db,$data[18]);
                                                            $item20 = mysqli_real_escape_string($db,$data[19]);

                                                    $import="INSERT into bp_applicant(bp_no,year_approved,date_approved,ap_initial,ap_brgy,brgy_code,bp_orNo,or_datepaid,building_cost,building_fees,building_noStoreys,building_engineer,applicant,ap_location,tax_receiptNo,ge_datepaid,tax_ge,admin_receiptNo,admin_datepaid,admin_fine) values('$item1','$item2','$item3','$item4','$item5','$item6','$item7','$item8','$item9','$item10','$item11','$item12','$item13','$item14','$item15','$item16','$item17','$item18','$item19','$item20')";
