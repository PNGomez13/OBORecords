...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">DATABASE | ARCHIVE CONFIRMED</a>
                </div>
        ...
        <?php
            ...
            INSERT INTO bp_applicant_archive SELECT * FROM bp_applicant WHERE bpApplicant_id='$applicant_id';
            DELETE FROM bp_applicant WHERE bpApplicant_id='$applicant_id';
            COMMIT;";
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="content">
                                <div class="header">
                                    <h4 class="title text-center">Record of <b><?php echo $applicant;?></b> has been moved to archive.<br>
                                </div>
                                <hr>
