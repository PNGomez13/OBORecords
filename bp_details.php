...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <?php
            ...
            $query = "SELECT * FROM bp_applicant WHERE bpApplicant_id = '$view_id';";
            ...
            if(mysql_num_rows($result) > 0){
                ...
                while($row = mysql_fetch_array($result)){
                                ...
                                echo "<div class=\"mdl-card__menu\">
                                            <a href=\"edit_record.php?id=$edit_id\" class=\"mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect mdl-button--primary\" id=\"edit\">
                                                <i class=\"material-icons mdl-color-text--white\">edit</i>
                                            </a>
                                            <div class=\"mdl-tooltip\" for=\"edit\"><strong>EDIT</strong></div>
                                            <a href=\"archive_confirm.php?id=$arc_id\" class=\"mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect mdl-button--primary\" id=\"archive\">
                                                <i class=\"mdl-color-text--white fa fa-archive\"></i>
                                            </a>
                                            <div class=\"mdl-tooltip\" for=\"archive\"><strong>ARCHIVE</strong></div>
                                            </div>  
                                        </div>       
                                      </div>";
                                echo "<div class=\"col-md-6\">
