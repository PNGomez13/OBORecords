...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">ARCHIVED RECORDS</a>
                </div>
        ...
        <?php
            ...
            $sql = "SELECT * FROM bp_applicant_archive LIMIT $start_from, $num_rec_per_page"; 
            $rs_result = mysql_query ($sql); //run the query

            $query = "SELECT bpApplicant_id, bp_no, date_approved, applicant, ap_location, building_engineer FROM bp_applicant_archive LIMIT $start_from, $num_rec_per_page";
            $result = mysql_query($query);

            $query1 = "SELECT bpApplicant_id, bp_no, date_approved, applicant, ap_location, building_engineer FROM bp_applicant_archive;";
                        ...
                        <div class=\"container-fluid\">
                            <div class=\"row\">
                                <div class=\"col-md-12\">
                                    <div class=\"card\">
                                        <div class=\"header\">
                                            <h2 class=\"title text-center\">All Records in Archive</h2>"; 
                                        ...
                                        <div class=\"content table-responsive table-full-width\">
                                            <table class=\"table table-hover table-striped\">
                                                ...
                                                <tbody>";
                                                    ...
                                                    while ($row = mysql_fetch_row($result)) { 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php echo"<td style=\"padding-top: 8px !important; padding-bottom: 8px !important;\">
                                                                        <a href=\"archive_details.php?id=$bp_id\" class=\"mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect mdl-button--primary\" id=\"details\">
                                                    ...
                                                    <?php 
                                                    $sql = "SELECT * FROM bp_applicant_archive"; 
                                                    $rs_result = mysql_query($sql); //run the query
